...
CREATE TABLE `surgeon` (
  ...
  KEY `userID` (`userID`),
  CONSTRAINT `surgeon_ibfk_1` FOREIGN KEY (`userID`) REFERENCES `user` (`userID`) ON DELETE CASCADE
...
INSERT INTO `surgeon` VALUES (2,10,'john','john@gmail.com','01234567890','General');
